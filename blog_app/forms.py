...
class CommentForm(forms.Form):
    ...
    email = forms.EmailField(widget=forms.TextInput(attrs={"id": "email", "type": "email", "class": "from-control input-lg","required": "required", "tabindex": "2"}),max_length=50, required=False)
